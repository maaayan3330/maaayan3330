...
### 🎬 YouTube Platform – Full Stack Application

A full-stack video platform inspired by YouTube.

* Developed a web application using **React**
* Built a backend with **Node.js & Express**
...
An intelligent agent navigating a stochastic environment.

* Implemented **A*** search for deterministic planning
* Combined with **MDP + Value Iteration**
...
A fast-paced reaction game ("Grab the Pizza").

* Built with **React + Vite + Tailwind CSS**
* Dynamic game logic with timers and random events
...
A word puzzle game focused on user interaction and UX.

* Controlled inputs with strict typing logic
* Smart focus handling using **useRef**
* Random word generation & shuffle logic
...
A flip-card memory game based on matching pairs.

* Built with **React**
* Implemented card flipping animations using CSS
* Game logic for matching pairs and resetting cards
...
Classic Tic-Tac-Toe game with dynamic game logic.

* Built with **React**
* Winner detection algorithm based on combinations
...
Classic arcade game built with strong OOP principles.

* Implemented using **Java**
* Used **interfaces, inheritance, and listeners**
